...
// const socialProviders: Array<"google" | "facebook" | "apple" | "email"> = ["google", "facebook", "apple", "email"]
const socialProviders: Array<"google" | "facebook" | "apple" | "email"> = ["google", "email"]
...
const SignInScreen: React.FC = () => {
  ...
  const handleSocialLogin = (provider: "google" | "facebook" | "apple" | "email") => {
    router.push({ pathname: "/(auth)/sign-up", params: { provider } });
    // const userData = {
  ...
  return (
    <LinearGradient colors={[colors.primary, colors.primaryDark]} style={signInStyles.container}>
      ...
      <View style={signInStyles.bottomButtonsContainer}>
        <Button title="Continue as a guest" onPress={handleGuestLogin} variant="secondary" />
      </View>
    </LinearGradient>
  )
}
