  ...
  return (
    ...
    >
      <Tabs.Screen
        ...
        options={{
          title: "Home",
          tabBarIcon: ({ color }) => <Ionicons name="home-outline" size={normalize(30)} color={color} />,
        }}
      />
      <Tabs.Screen
        name="leaderboard"
        options={{
          title: "Leaderboard",
          tabBarIcon: ({ color }) => <Ionicons name="trophy-outline" size={normalize(30)} color={color} />,
        }}
      />
      <Tabs.Screen
        name="achievements"
        options={{
          title: "Achievements",
          tabBarIcon: ({ color }) => (
            <Ionicons name="star-outline" size={normalize(30)} color={color} /> // Icono de estrella como en el wireframe
          ),
        }}
      />
      <Tabs.Screen
        ...
        options={{
          title: "Profile",
          tabBarIcon: ({ color }) => <Ionicons name="person-circle-outline" size={normalize(30)} color={color} />,
        }}
      />
    </Tabs>
  )
